...
export default function MainPage() {
  return (
    <div className="w-full flex flex-col items-center pt-5">
      ...
      <section className="border border-black w-full h-32 flex flex-row m-5">
      ...
      <section className="border border-black w-full flex flex-row mb-5">
        <section className="border border-black w-1/2">
          <section className="border border-black h-16">
            {/* 공지사항 */}
            <NoticeForm />
          </section>
          <section className="border border-black h-16">
        ...
        <section className="border border-black w-1/2 flex flex-row">
          <section className="border border-black w-1/2">
            {/* 자랑하기/체험하기 등 사진 게시판 */}
            <PhotoForm />
          </section>
