...
//import { userDataState } from "./StAtom";

export default function LoginCp({ handleLogout }) {
        ...
        <div className="w-full max-w-lg px-10 py-8 mx-auto bg-white border rounded-3xl shadow-2xl">
          <div className="max-w-md mx-auto space-y-4 flex-col justify-center text-center ">
            ...
            <div className="flex gap-3 pt-3 justify-center items-center">
              <Link to="/">
                <button className="border hover:border-green-600 px-4 py-2 rounded-lg shadow ring-1 ring-inset ring-gray-300">
                  home
                </button>
              </Link>
              <button
                onClick={handleLogout}
                className="border hover:border-green-600 px-4 py-2 rounded-lg shadow ring-1 ring-inset ring-gray-300"
              >
                Logout
              </button>
            </div>
